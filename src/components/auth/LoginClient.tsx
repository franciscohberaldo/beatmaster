      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-1 border border-white/10 rounded-xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-[10px] font-mono text-white/40 uppercase tracking-wider block mb-1">Email</label>
              <input
            ...
            <div>
              <label className="text-[10px] font-mono text-white/40 uppercase tracking-wider block mb-1">Password</label>
              <input
            ...
            {error && (
              <p className="text-xs font-mono text-rose-400 bg-rose-500/10 rounded-lg px-3 py-2">{error}</p>
            )}
          ...
          <p className="text-center text-xs font-mono text-white/20 mt-4">
            <a href="/studio" className="text-white/40 hover:text-white/60 underline">Usar sem login →</a>
          </p>
        </div>
      </div>
    </div>
